...
<br><br>
<div id="bWrite_wrap" class="margin" style="margin-top: 250px" > <%--제목도 멀티폼으로 --%>
 <form method="post" action="admin_board_write_ok" onsubmit="return bw_check();">
   <table id="bWrite_t" class="tablebox">
     ...
     <tr>
      <td>제목</td>
      <td ><input type="text" Placeholder="writer" name="abboard_title" id="board_name" size="20px"/></td>
   
    
     <tr>
      <td>내용</td>
      <td class="bottom_line"><textarea name="abboard_cont" id="summernote" cols="70%" rows="100%" ></textarea></td>
     </tr>
