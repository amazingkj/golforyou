...
<body>
	...
	<form method="get" action="class_deatil">
		...
		<div id="wrap">
					...
					<div class="section01">
						...
						<%-- section01의 왼쪽(이미지) --%>
						<div class="left_side">
							<div class="image01"><img src="/upload${c.cimage}"/></div>
						</div>
						...
						<div class="right_side">
							...
							<div class="tab_container">
								...
								<div id="tab1" class="tab_content">
									<br>
									<div class="price">
										<span class="totalPrice">${c.csprice} 원</span> <span
											class="vat">(VAT 포함가)</span><br /> <br />
									</div>
									<div class="class_detail">
										<div class="class_info">라운딩 골프 레슨 ${c.csrounding}회</div>
								...
								<div id="tab2" class="tab_content">
									<br>
									<div class="price">
										<span class="totalPrice"><c:out value="${c.cdprice}" />원</span>
										<span class="vat">(VAT 포함가)</span><br /> <br />
									</div>
									<div class="class_detail">
										<div class="class_info">
											라운딩 골프 레슨
											<c:out value="${c.cdrounding}" />
											회
										</div>
										<div class="class_desc">
											<p>
												<c:out value="${c.cddesc}" />
											</p>
										</div>
									</div>
									<div class="class_detail2">
								...
								<div id="tab3" class="tab_content">
									<br>
									<div class="price">
										<span class="totalPrice"><c:out value="${c.cprice}" />원</span>
										<span class="vat">(VAT 포함가)</span><br /> <br />
									</div>
									<div class="class_detail">
										<div class="class_info">
											라운딩 골프 레슨
											<c:out value="${c.cprounding}" />
											회
										</div>
										<div class="class_desc">
											<p>
												<c:out value="${c.cpdesc}" />
											</p>
										</div>
									</div>
									<div class="class_detail2">
						...
						<div class="tab_container">
							...
							<div id="tab4" class="tab_content">
								<div class="tab4_left">
									...
									<p>
										안녕하세요.<br /> <br /> 필드 골프 레슨 전문 <strong><c:out
												value="${c.cteacher}" /> 프로</strong>입니다.<br /> <br /> 인도어에서 혹은
										실내에서 많은 레슨이 이루어집니다.<br /> <br /> 이것을 실전에 사용하려면 많은 시간과 노력이
										필요합니다.<br /> <br /> 그래서 저희는 체계적인 레슨 프로그램으로 필드에서 <br /> <br />
										고객의 요구에 부합하는 레슨 서비스를 제공하고 있습니다.<br /> <br /> <br /> <br />
										본 레슨 서비스는<br /> <br /> 1. 라운딩 전 60~90분 인도어에서 레슨이 이루어집니다. 이 때
										고객님께 필요한 부분을 체크합니다.<br /> <br /> 2. 라운딩 레슨에서 꼭 필요한 부분을 정확한
										설명과 응용방법으로 고객님의 실력 향상에 도움을 드립니다.<br /> <br /> 3. 레슨이 끝난 후,
										개개인의 연습장에서 어떻게 연습을 하여야 되는지 알려드립니다.<br /> <br /> 4. 라운딩 중 레슨
										동영상을 통해 다시 한 번 연습 방법을 찾을 수 있도록 보내드립니다.<br /> <br /> 5. 레슨인원은
										총 3명으로 필드에서 충분한 연습과 레슨이 이루어지도록 합니다. <br /> <br /> <br />
									</p>
									...
									<br />
									<p>
										- 본인 골프 클럽<br /> 1. 필드 레슨은 시작 4일 이후에는 취소가 되지 않습니다.<br /> 2.
										우천 및 천재 지변으로 인해 레슨이 불가할 경우 2주내 다시 진행합니다.<br /> 3. 18홀 레슨 중 중도
										정지는 9홀 단위로 계산합니다.
									</p>
								</div>
								<div class="tab4_right">
									<div class="notice">
										...
										<div class="warning2">서비스 제공이 완료된 이후에 전문가에게 결제 대금이
											전달됩니다.</div>
									</div>
									<div class="class_teacher">
										<div class="teacher_name">
											<span><c:out value="${c.cteacher}" />&nbsp;프로</span>
										</div>
							...
							<div id="tab7" class="tab_content">
								...
								<p>
									...
									- 학원설립, 운영자, 교습자 및 개인과외교습자는 학습자가 수강을 계속할 수 없는 경우 또는 학원의 등록말소,
									교습소 폐지 등으로 교습을 계속할 수 없는 경우에는 학습자로부터 받은 교습비를 반환하는 등 학습자를 보호하기
									위하여 필요한 조치를 하여야 한다. <br /> <br /> 1. 레슨을 제공할 수 없거나, 레슨 장소를
									제공할 수 없게 된 날 : 이미 납부한 레슨비 등을 일한 계산한 금액 환불 <br /> <br /> 2.
									레슨기간이 1개월 이내의 경우<br /> - 레슨 시작전 : 이미 납부한 레슨비 전액 환불<br /> - 총
									레슨 시간의 1/3 경과전 : 이미 납부한 레슨비의 2/3에 해당액 환불<br /> - 총 레슨 시간의 1/2
									경과전 : 이미 납부한 레슨비용의 1/2에 해당액 환불<br /> - 총 레슨시간의 1/2 경과후 : 반환하지
									않음 <br /> <br /> 3.레슨 기간이 1개월을 초과하는 경우 - 레슨 시작전 : 이미 납부한 레슨비
									전액 환불<br /> - 레슨 시작후 : 반환사유가 발생한 당해 월의 반환 대상 레슨비(레슨비 징수기간이 1개월
									이내인 경우에 따라 산출된 수강료를 말한다)와 나머지 월의 레슨비 전액을 합산한 금액 환불 <br /> <br />
									* 총 레슨 시간의 레슨비 징수기간 중의 총레슨시간을 말하며, 반환 금액의 산정은 반환 사유가 발생한 날까지 경과
									된 레슨시간을 기준으로 함
								</p>
							</div>
