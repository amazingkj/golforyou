	...
	<div id="wrap-edit">
		...
		<form name="form1" method="post" action="/insertGolfcouse_ok"
			...
			<table >
				...
				<tr>
					<td>골프장명</td>
					<td><input name="gc_title" id="gc_title" size="50" value="${item.gc_title}"></td>
				</tr>
				<tr>
					<td><br /></td>
				</tr>
				<tr>
					<td>골프장영문명</td>
					<td><input name="gc_english" id="gc_english" size="50" value="${item.gc_english}"></td>
				</tr>
				<tr>
					<td><br /></td>
				</tr>
				<tr>
					<td>지역</td>
					<td><input name="gc_area" id="gc_area" size="50" value="${item.gc_area}"></td>
				</tr>
				<tr>
					<td><br /></td>
				</tr>
				<tr>
					...
					<td><input name="gc_hole" id="gc_hole" size="20"
						placeholder="숫자로 입력헤주세요." value="${item.gc_hole}"></td>
				</tr>
				<tr>
					<td><br /></td>
				</tr>
				<tr>
					...
					<td><input name="gc_golf" id="gc_golf" size="20"
						placeholder="숫자로 입력헤주세요." value="${item.gc_golf}"></td>
				</tr>
				<tr>
					<td><br /></td>
				</tr>
				<tr>
					...
					<td><input name="gc_length" id="gc_length" size="40"
						placeholder="숫자로 입력헤주세요." value="${item.gc_length}"></td>
		</tr>
		<tr>
					<td><br /></td>
				</tr>
				...
				<tr>
					...
					버뮤다그래이스&emsp;<input type="checkbox" value="버뮤다그래이스"  class="btn01" name="gc_kind" id="gc_kind" value="${item.gc_kind}" />
					&emsp;벤트그래이스&emsp;<input type="checkbox" value="벤트그래스"  class="btn01"  name="gc_kind" id="gc_kind" value="${item.gc_kind}"/>
					&emsp;켄터키블루그래스&emsp;<input type="checkbox" value="켄터키블루그래스"  class="btn01"   name="gc_kind" id="gc_kind" value="${item.gc_kind}" />
					&emsp;톰 페스큐&emsp;<input type="checkbox" value="톰 페스큐"  class="btn01"  name="gc_kind" id="gc_kind" value="${item.gc_kind}"/>		
				</tr>
				<tr>
					<td><br /></td>
				</tr>
				...
				<tr>
					<td>코스타입</td>
					<td><input name="gc_type" id="gc_type" size="60" value="${item.gc_kind}"></td>
				</tr>
<tr>
					<td><br /></td>
				</tr>
				<tr>
					<td>코스구성</td>
					<td><input name="gc_configuration" id="gc_configuration" size="60" value="${item.gc_configuration}"></td>
				</tr>
				<tr>
					<td><br /></td>
				</tr>
				<tr>
					<td>캐디(유/무)</td>
					<td><select name="gc_caddy" id=gc_caddy" value="${item.gc_caddy}" >
				...
				<tr>
					<td>카트(유/무)</td>
					<td><select name="gc_cart" id=gc_cart" value="${item.gc_cart}"  >
...
<tr>
	...
	<tr>
				...
				<tr>
					<td>골프장 주소</td>
						<td>
						<input type="text" id="gc_address_postcode" name="gc_address_postcode" placeholder="우편번호" value="${item.gc_address_postcode}">
						<input type="button" onclick="gc_address_execDaumPostcode()" value="우편번호 찾기"><br>
						<input type="text" id="gc_address_roadAddress"  name="gc_address_roadAddress"placeholder="도로명주소" value="${item.gc_address_roadAddress}">
						<input type="text" id="gc_address_jibunAddress" name="gc_address_jibunAddress"placeholder="지번주소" value="${item.gc_address_jibunAddress}">
				...
				<tr>
					...
					<td><input name="gc_move" id="gc_move" size="60"
						placeholder="예) 해당고속도로-해당ic-해당톨게이트-해당골프장" value="${item.gc_move}"></td>
				</tr>
				<tr>
					<td><br /></td>
				</tr>
				<tr>
					...
					<td><input name="gc_date" id="gc_date" size="30"
						placeholder=" 년도만 입력해주세요." value="${item.gc_date}"></td>
				</tr>
				<tr>
					<td><br /></td>
					<td><br /></td>
