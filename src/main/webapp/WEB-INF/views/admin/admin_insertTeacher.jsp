...
<body>
	...
	<div id="wrap-edit2">
		<h2>강사 등록하기</h2>
		<br />
		<form name="form5" method="post" action="/admin/insertTeacher_ok" onsubmit="return write_check_teacher();">
			<table>
				<tr>
					<td><hr /></td>
					<td><hr /></td>
				...
				<tr>
					<td>강사명</td>
					<td><input name="tname" id="tname" size="15"> 프로</td>
				</tr>
				<tr>
					<td>강사 성별</td>
				...
				<tr>
					...
					<input type="button" value="목록" class="btn01" onclick="location='/admin/admin_classTeacher';" />
					</td>
				</tr>
			</table>
		</form>
