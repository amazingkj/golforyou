...
function go_pop(){
 ...
 window.open("./planlist","new","width=415, height=620, resizable=no, scrollbars=no, status=no, location=no, directories=no;");
}
</script>
<body onload="go_pop()">
<br><br>
<div class="section" style="margin:150px 0px 0px 0px;">
	<div class="header_cont">
		<div class="header_info">
			<div class="info_tit">
				<p class="tit-basic">
					<span class="tit-ko"></span> <span class="tit-area">한국,경기도</span>
				</p>				
...
// 주소로 좌표를 검색합니다
geocoder.addressSearch(${gc.gc_address_roadAddress}, function(result, status)) {
