					...
					<div class="tab_container">
						...
						<div id="tab1" class="tab_content">
							...
							<div class="price">
								...
								<fmt:formatNumber value="${item.fsprice}" pattern="#,###" />원</span>
								<span class="vat">(VAT 포함가)</span><br /> <br />
							</div>
							<div class="class_detail">
								<div class="class_info">라운딩 골프 레슨 ${item.fsrounding}회</div>
						...
						<div id="tab2" class="tab_content">
							...
							<div class="price">
								<span class="totalPrice">
								<fmt:formatNumber value="${item.fdprice}" pattern="#,###" />원</span>
								<span class="vat">(VAT 포함가)</span><br /> <br />
							</div>
							<div class="class_detail">
								<div class="class_info">
									라운딩 골프 레슨
									<c:out value="${item.fdrounding}" />
									회
								</div>
								<div class="class_desc">
									<p>
										<c:out value="${item.fddesc}" />
									</p>
								</div>
							</div>
							<div class="class_detail2">
						...
						<div id="tab3" class="tab_content">
							...
							<div class="price">
								<span class="totalPrice">
								<fmt:formatNumber value="${item.fpprice}" pattern="#,###" />원</span>
								<span class="vat">(VAT 포함가)</span><br /> <br />
							</div>
							<div class="class_detail">
								<div class="class_info">
									라운딩 골프 레슨
									<c:out value="${item.fprounding}" />
									회
								</div>
								<div class="class_desc">
									<p>
										<c:out value="${item.fpdesc}" />
									</p>
								</div>
							</div>
							<div class="class_detail2">
								...
								<div class="teacher_career">
									...
									<div class="introduce_detail">
										...
										<div class="phone_detail">
											<p>
												<c:out value="${item.fphone}" />
											</p>
										</div>
										<div class="address">지역</div>

										<div class="address_detail">
											<div class="address_detail01">
												<c:out value="${item.faddr}" />
											</div>
											<div class="address_detail02">
												<c:out value="${item.faddr2}" />
											</div>
										</div>
									</div>
								</div>
						...
						<div class="table_price">
							<div class="detail1">
								...
								<div class="detail_vertical">
									...
									<div class="standard2">
										<fmt:formatNumber value="${item.fsprice}" pattern="#,###" />
										원
									</div>
								</div>
								<div class="detail_vertical">
									...
									<div class="deluxe2">
										<fmt:formatNumber value="${item.fdprice}" pattern="#,###" />
										원
									</div>
								</div>
								<div class="detail_vertical">
									...
									<div class="premium2">
										<fmt:formatNumber value="${item.fpprice}" pattern="#,###" />
										원
									</div>
								</div>
							</div>
